...
// Form Submission (Mentorship and Contact)
document.getElementById('mentorship-form').addEventListener('submit', function (e) {
    e.preventDefault();
    const interest = document.getElementById('interest').value;
    let message = 'Thank you for applying! ';
    if (interest === 'documentary') {
        message += 'We’ll match you with a documentary filmmaking mentor.';
    } else if (interest === 'podcast') {
        message += 'We’ll match you with a podcasting mentor.';
    } else {
        message += 'We’ll match you with a broadcast journalism mentor.';
    }
    alert(message);
    this.reset();
});
...
function sendMessage() {
    ...
    if (message) {
        ...
        setTimeout(() => {
            ...
            botMessage.innerHTML = `<strong>Bot:</strong> Thanks for your message! How else can I assist you?`;
...
// Three.js for WebGL Background (Narrative Nexus)
